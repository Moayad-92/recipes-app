...
import { SafeAreaView, ScrollView, View, Text, Image, Linking, TouchableOpacity, } from 'react-native';
import axios from 'axios';
import {meal_details} from '../Styles/PageStyles';
    ...
    return(
        <SafeAreaView style={{flex:1}}>
            <ScrollView style={meal_details.container}>
                ...
                <Image source={{uri: mealDetails.strMealThumb}}
                style={meal_details.image}
                />
                <View style={meal_details.area_container}>
                    <Text style={meal_details.area_text}>* {mealDetails.strCategory} *</Text>
                ...
                <View style={meal_details.instructions_container}>
                    ...
                    <Text style={meal_details.instructions_text}>{mealDetails.strInstructions}</Text>
                </View>
                <TouchableOpacity style={meal_details.youtube_container}
